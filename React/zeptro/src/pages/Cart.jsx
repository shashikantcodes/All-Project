        ...
        <div className='mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0'>
            {
                cartItem.length > 0 ? <div>
                            ...
                            <div className='bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                                ...
                                <div>
                                    ...
                                    <div className='flex gap-3'>
                                        <input type="text" placeholder='EnterCode' className='p-2 rounde-md w-full' />
                                        <button className='bg-white text-black border border-gray-200 px-4 cursor-pointer py-1 rounded-md'>Apply</button>
                                    </div>
                                </div>
                                <button className='bg-red-500 text-white px-3 py-2 rounded-md w-full cursor-pointer mt-3 '>Procced To Checkout</button>
                    ...
                    <button onClick={() => navigate('/products')} className='bg-red-500 text-whitw px-3 py-2 rounded-md cursor-pointer'>Continue Shopping</button>
                </div>
            }
        </div>
    )
