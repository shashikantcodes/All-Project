    ...
    return (
        <div className='space-y-4 mt-2 rounded-md'>
            <div className='bg-gray-100 flex gap-7 items-center p-2 rounded-md'>
                <img src={product.image} alt={product.title} className='md:h-60 md:w-60 h-25 w-25rounde-md cursor-pointer' onClick={() => navigate(`/products/${product.id}`)} />
                <div className='space-y-2'>
                    ...
                    <p className='text-sm '>FREE delivery <span className='font-semibold'>Fri,18 Apr</span> <br />
                        or fastest delivery <span className='font-semibold'>Tomorrow,17Apr</span>
                    </p>
